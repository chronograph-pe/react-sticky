...
var Slider = function (_React$Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function innerSliderRefHandler(ref) {
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(enquire, 'enquire', 'src/slider.js');

  __REACT_HOT_LOADER__.register(Slider, 'Slider', 'src/slider.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/slider.js');
}();
