...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(EventHandlers, 'EventHandlers', 'src/mixins/event-handlers.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/mixins/event-handlers.js');
}();
